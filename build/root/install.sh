...
curl --connect-timeout 5 --max-time 600 --retry 5 --retry-delay 0 --retry-max-time 60 -o /tmp/Scripts-main.zip -L https://github.com/mddewittjr/Scripts/archive/refs/heads/main.zip

# unzip build scripts
unzip /tmp/Scripts-main.zip -d /tmp

# move shell scripts to /root
mv /tmp/Scripts-main/shell/arch/docker/*.sh /usr/local/bin/
